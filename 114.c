// Write a program to find the maximum scaler product of two veactor
// There will be two array and we have to sort the array.
// First array in Ascending oreder and Second array also in ascending order
#include<stdio.h> 
...
int main(){
   ...
   printf("\nAfter sorting the 1st array in ascending order is : ");
    ...
    // maximum scaler sum product of arr1 and arr2
    int sum = 0;
    printf("\nThe maximum scaler product of arr1 and arr2 : ");
    for(i=0; i<n; i++){
